...
public class FriendshipAdapter extends RecyclerView.Adapter<FriendshipAdapter.ViewHolder> {
    ...
    public FriendshipAdapter(Context context, List<Theme> themeList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(context).load(themeList.get(position).getTheme_thumbnail()).into(holder.friendship);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            friendship=itemView.findViewById(com.example.tablayoutnew.R.id.birthday);
