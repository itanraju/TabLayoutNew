...
public class HindiAdapter extends RecyclerView.Adapter<HindiAdapter.ViewHolder> {
    ...
    public HindiAdapter(Context context, List<Theme> themeList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new HindiAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {

        Glide.with(context).load(themeList.get(position).getTheme_thumbnail()).into(holder.hindi);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            hindi=itemView.findViewById(R.id.birthday);
        }
    }
}
